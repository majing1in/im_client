    ...
    private void onPush(OSS oss) {
        ...
        mOSSAsyncTask = oss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                BroadcastUtils.initLocalBroadcastManager(BroadcastConstants.USER_UPDATE_ACTIVITY, UserUpdateActivity.context, MessageConstants.USER_INFO_UPDATE__BROADCAST, MessageConstants.USER_INFO_UPDATE_SUCCESS);
